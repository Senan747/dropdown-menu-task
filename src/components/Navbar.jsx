  ...
  return (
    <div className="w-full flex flex-row items-center justify-between py-5 px-24 bg-primary-blue text-white max-md:px-6">
      ...
      <div className="flex items-center flex-row justify-around w-full pl-20 max-md:pl-10">
        ...
        <div className="cursor-pointer group relative" onClick={toggleDropdown}>
          <p>Socials</p>
          <div
        ...
        <div>
          <button className="px-4 py-2 bg-primary-blue border-2 border-white text-white rounded-full">
            Sign in
          </button>
        </div>
      </div>
